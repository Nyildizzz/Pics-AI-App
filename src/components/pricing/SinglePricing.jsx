...
const checkIcon = (
    <svg width="8" height="6" viewBox="0 0 8 6" className={style.checkIcon}>
  ...
  const crossIcon = (
    <svg width="7" height="7" viewBox="0 0 8 8" className={style.crossIcon}>
...
const pricingData = [
    {
        ...
        iconsText : ["All UI Components","Use with Unlimited Projects","Commercial Use","Email Support","Lifetime Access","Free Lifetime Updates"],
